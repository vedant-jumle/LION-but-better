...
#SBATCH --output=/scratch/vvjumle/logs/lion_f09_%j.out
#SBATCH --error=/scratch/vvjumle/logs/lion_f09_%j.err
...
echo "=== Starting LION-D Tiny training (fixed decay lambda=0.9) ==="
